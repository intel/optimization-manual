...
#ifndef AMX_REF_GEMM_INT8_BENCH_HPP
#define AMX_REF_GEMM_INT8_BENCH_HPP

#include <stddef.h>
#include <stdint.h>

#define M 1024          // Number of rows in the A or C matrices
#define K 64            // Number of columns in the A or rows in the B matrices
#define N 32            // Number of columns in the B or C matrices
#define M_ACC 64        // Number of C accumulators spanning the M dimension
