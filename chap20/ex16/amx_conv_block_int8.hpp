...
#define H 34             // The height of the activation frame
#define W 34             // The width of the activation frame
#define MA (H*W)         // The M dimension (rows) of the A matrix
#define K 4              // Number of activation channels
#define N 64             // Number of output channels
...
#define MC_CACHE 256 // Extent of cache block along the M dimension of the C matrix
#define K_CACHE  4   // Extent of cache block along the K dimension
#define N_CACHE  32  // Extent of cache block along the N dimension
typedef res_type_t acc_type_t; // The accumulation data type (either int32 or float)
acc_type_t aC_mem[MC_CACHE/TILE_M][N_CACHE/TILE_N][TILE_M][TILE_N]; // Accumulator buffers of C
