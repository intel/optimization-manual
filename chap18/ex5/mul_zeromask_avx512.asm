...
;	# void mul_zeromask_avx512(float *a, float *b, float *out1, float *out2,
;	#	size_t N);
...
.code
mul_zeromask_avx512 PROC public
...
loop1:
	vmulps zmm0{k1}{z}, zmm3, zmm2
	vmulps zmm1{k1}{z}, zmm3, zmm2
	dec rax
	jnle loop1
