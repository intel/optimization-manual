...
#else
static uint8_t b[64] __attribute__((aligned(64)));
#endif
...
static void BM_lookup_novbmi(benchmark::State &state)
{
...
static void BM_lookup_vbmi(benchmark::State &state)
{
