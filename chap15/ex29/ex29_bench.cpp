...
static void BM_sqrt_rsqrtps_sse(benchmark::State &state)
{
...
static void BM_sqrt_vrsqrtps_avx(benchmark::State &state)
{
	int len = state.range(0);
...
BENCHMARK(BM_sqrt_rsqrtps_sse)
    ...
    ->Arg(1 << 16)
    ->Arg(1 << 18);
BENCHMARK(BM_sqrt_vrsqrtps_avx)
    ->Arg(1 << 6)
    ->Arg(1 << 8)
    ->Arg(1 << 10)
    ->Arg(1 << 12)
